...
- Figure 3: Non-metric multidimensional scaling analyses for metagenomic DNA and RNA sequences obtained from enrichment culture samples
- Figure S2: Beta diversity analyses for metagenome-assembled genomes obtained from enrichment culture samples omitting aerobic cultures
...
- Appendix I: Preparing SQM directories for downstream analyses
...
ggsave("Fig1_relative_abundance_and_nitrogen_metabolic_for_starting_consortium_PacBio_sequencing_heatmap_20250929.pdf", height=70, width=50, device="pdf", limitsize = FALSE)
ggsave("Fig1_relative_abundance_and_nitrogen_metabolic_for_starting_consortium_PacBio_sequencing_heatmap_20250929.jpg", 
       dpi = 300, height=70, width=50, device= "jpeg", limitsize = FALSE)
ggsave("Fig1_relative_abundance_and_nitrogen_metabolic_for_starting_consortium_PacBio_sequencing_heatmap_20250929.tiff", 
       dpi = 300, height=70, width=50, plot = Long_read_MAGs_sylph_combined_plot, device= "tiff", limitsize = FALSE)
```
...
ggsave("FigS1_OD_pH_data_from_enrichment_cultures_scatter_plot_20250929.pdf", height=12, width=24, device="pdf")
ggsave("FigS1_OD_pH_data_from_enrichment_cultures_scatter_plot_20250929.jpg", height=12, width=24, device="jpeg")
ggsave("FigS1_OD_pH_data_from_enrichment_cultures_scatter_plot_20250929.tiff", height=12, width=24, device="tiff")
```
...
Final_nitrogen_plot
ggsave("Fig2_nitrogen_chemical_analyses_scatter_plot_20250929.pdf", height=20, width=24, device="pdf")
ggsave("Fig2_nitrogen_chemical_analyses_scatter_plot_20250929.jpg", dpi = 300, height=20, width=24, device="jpeg")
ggsave("Fig2_nitrogen_chemical_analyses_scatter_plot_20250929.tiff", dpi = 300, height=20, width=24, device="tiff")
```
...
Full_dereplicates_MAG_scores_categorical_variables <- Full_dereplicated_MAG_scores %>%
...
Full_dereplicated_MAG_ordination <-  ggplot(Full_dereplicates_MAG_scores_categorical_variables, aes(x = NMDS1, y = NMDS2)) + 
...
ggsave("Fig3A_dereplicated_MAG_enrichment_cultures_time_series_NMDS_ordination_20250929.pdf", height=6, width=8, device="pdf", limitsize = FALSE)
```
...
ggsave("Fig3B_SqueezeCoassembly_DNA_reads_NMDS_ordination_20250929.pdf", height=6, width=8, device="pdf", limitsize = FALSE)
```
...
ggsave("Fig3C_SqueezeCoassembly_RNA_reads_NMDS_ordination_20250929.pdf", height=6, width=8, device="pdf", limitsize = FALSE)
```
...
SqueezeCoassembly_DNA_read_NMDS_no_legend <- SqueezeCoassembly_DNA_read_NMDS + theme(legend.position = "none")
```
...
ggsave("Fig3_MAG_DNA_RNA_read_NMDS_ordinations_combined_20250929.pdf", dpi = 300, height=6, width=22, device="pdf")
ggsave("Fig3_MAG_DNA_RNA_read_NMDS_ordinations_combined_20250929.jpg", dpi = 300, height=6, width=22, device="jpeg")
ggsave("Fig3_MAG_DNA_RNA_read_NMDS_ordinations_combined_20250929.tiff", dpi = 300, height=6, width=22, device="tiff")
```
...
ggsave("FigS2_dereplicated_MAG_enrichment_cultures_time_series_aerobic_cultures_omitted_NMDS_ordination_20250929.pdf", dpi = 300, height=6, width=8, device="pdf", limitsize = FALSE)
ggsave("FigS2_dereplicated_MAG_enrichment_cultures_time_series_aerobic_cultures_omitted_NMDS_ordination_20250929.jpg", dpi = 300, height=6, width=8, device="jpeg", limitsize = FALSE)
ggsave("FigS2_dereplicated_MAG_enrichment_cultures_time_series_aerobic_cultures_omitted_NMDS_ordination_20250929.tiff", dpi = 300, height=6, width=8, device="tiff", limitsize = FALSE)
```
...
ggsave("FigS3A_Nitrogen_cycling_genes_RNA_reads_coassembly_percent_20250929.pdf", height=16, width=40, device="pdf", limitsize = FALSE)
```
...
ggsave("FigS3B_Nitrogen_cycling_genes_RNA_reads_coassembly_tpm_20250929.pdf", height=16, width=40, device="pdf", limitsize = FALSE)
```
...
ggsave("FigS3C_Nitrogen_cycling_genes_RNA_reads_no_week0_coassembly_percent_20250929.pdf", height=16, width=40, device="pdf", limitsize = FALSE)
```
...
ggsave("FigS3D_Nitrogen_cycling_genes_RNA_reads_no_week0_coassembly_tpm_20250929.pdf", height=16, width=40, device="pdf", limitsize = FALSE)
```
...
ggsave("FigS3_RNA_mapped_nitrogen_genes_coassembly_combined_20250929.pdf", height=48, width=48, device="pdf")
ggsave("FigS3_RNA_mapped_nitrogen_genes_coassembly_combined_20250929.jpg", dpi = 300, height=48, width=48, device="jpeg")
ggsave("FigS3_RNA_mapped_nitrogen_genes_coassembly_combined_20250929.tiff", dpi = 300, height=48, width=48, device="tiff")
```
...
ggsave("FigS4_RNA_mapping_to_bins_reformatted_stacked_barplot_20250929.pdf", height=20, width=40, device="pdf", limitsize = FALSE)
ggsave("FigS4_RNA_mapping_to_bins_reformatted_stacked_barplot_20250929.jpg", dpi = 300, height=20, width=40, device="jpeg", limitsize = FALSE)
ggsave("FigS4_RNA_mapping_to_bins_reformatted_stacked_barplot_20250929.tiff", dpi = 300, height=20, width=40, device="tiff", limitsize = FALSE)
```
...
ggsave("Fig4_relative_abundance_MAG_enrichment_cultures_time_series_1percent_heatmap_20250929.pdf", 
...
ggsave("Fig4_nitrogen_metabolism_MAG_enrichment_cultures_time_series_1percent_heatmap_20250929.pdf", 
       height=100, width=110, device="pdf", limitsize = FALSE)
```
...
ggsave("Fig4_one_percent_cutoff_relative_abundance_and_nitrogen_metabolism_for_MAG_enrichment_cultures_time_series_heatmap_20250929.pdf", 
       dpi = 300, height=85, width=110, device="pdf", limitsize = FALSE)

ggsave("Fig4_one_percent_cutoff_relative_abundance_and_nitrogen_metabolism_for_MAG_enrichment_cultures_time_series_heatmap_20250929.jpg", 
       dpi = 300, height=85, width=110, device="jpeg", limitsize = FALSE)

ggsave("Fig4_one_percent_cutoff_relative_abundance_and_nitrogen_metabolism_for_MAG_enrichment_cultures_time_series_heatmap_20250929.tiff", 
       dpi = 300, height=85, width=110, device="tiff", limitsize = FALSE)
```
# Figure S5: % RNA mapped to different taxa from genome bin data
...
ggsave("FigS5_Nitrogen_gene_RNA_mapping_to_genus_reformatted_stacked_barplot_20250929.pdf", height=20, width=46, device="pdf", limitsize = FALSE)
ggsave("FigS5_Nitrogen_gene_RNA_mapping_to_genus_reformatted_stacked_barplot_20250929.jpg", dpi = 300, height=20, width=46, device="jpeg", limitsize = FALSE)
ggsave("FigS5_Nitrogen_gene_RNA_mapping_to_genus_reformatted_stacked_barplot_20250929.tiff", dpi = 300, height=20, width=46, device="tiff", limitsize = FALSE)
```
...
Amino_acid_RNA_read_mapping_top_25 <-  Amino_acid_read_mapping_data %>%
                                       ...
                                       ggplot(aes(x= Replicate_number, y = reorder(kegg_ID, -TPM), fill= TPM)) +
                                       geom_tile(aes()) + 
                                       facet_nested(~Metabolic_treatment + Time_point, 
...
ggsave("FigS6_amino_acid_RNA_read_mapping_top_25_hits_heatmap_20250929.pdf", height=40, width=120, device="pdf", limitsize = FALSE)
ggsave("FigS6_amino_acid_RNA_read_mapping_top_25_hits_heatmap_20250929.jpg", dpi = 300, height=40, width=120, device="jpeg", limitsize = FALSE)
ggsave("FigS6_amino_acid_RNA_read_mapping_top_25_hits_heatmap_20250929.tiff", dpi = 300, height=40, width=120, device="tiff", limitsize = FALSE)
```
...
3. Finish generating the matrices and export them as .Rdata files to facilitate loading into R.
```{r}
...
1. Subset the functions of interest in the entire DNA and RNA read data set, then subset the RNA samples of interest. Generate an initial figure which will serve as a ggplot2 object that will be edited directly (editing the dataframe while preserving the subsetting from SQMTools is not possible).
```{r}
...
1. Reload SQM object containing the genome bins and subset the RNA data.
```{r}
...
SqueezeExtBins_RNA_read_data = subsetSamples(SqueezeExtBins, c(
                                            ...
                                            remove_missing = FALSE)
```
2. Plot the bin level mapping to get a sense of the % unmapped. Apply custom formatting to improve presentation.
```{r}
...
```
3. Generate additional SQM objects that subset the nitrogen functional genes using the bin data as the input.
```{r}
